...
\begin{itemize}
  \item La gestion du dossier administratif unique de mobilité est gérée à l'UNamur, par \href{mailto:mobility.sciences@unamur.be}{Mme Carole Payen}. Tel : +32 (0)81 72 40 98, +32 (0)81 72 54 31. 
  \item L'interface pour la gestion des bourses de mobilité est gérée par l'UCLouvain, par  \href{mailto:aloysia.stephenne@uclouvain.be}{Mme Aloysia Stephenne} (qui reçoit les informations directement de Mme Payen, une fois toute la sélection des projets et lieux de stages est terminée)
\end{itemize}
