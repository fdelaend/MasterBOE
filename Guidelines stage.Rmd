...
Ce guide pour l'année académique `r paste(academic_year_1, academic_year_2, sep="-")` est destiné aux étudiants en master en biologie des organismes et écologie (BOE). Il reprend les modalités et les dates limites du stage qui est réalisé en deuxième année du master. Abréviations utilisées : M1, M2 : premier et second année du master ; Q1, Q2 : premier et second quadrimestre.
...
Pour ceux désirant partir en Europe, le formulaire doit être rempli pour le deuxième vendredi de septembre en M2 (DATE: `r convert_to_format(dmy(get_last_friday(month="08", year=academic_year_2)) %m+% weeks(2))`). 
